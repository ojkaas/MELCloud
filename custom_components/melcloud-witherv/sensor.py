...
ERV_SENSORS: tuple[MelcloudSensorEntityDescription, ...] = (
    ...
    MelcloudSensorEntityDescription(
        ...
        translation_key="actual_supply_fan_speed",
        icon="mdi:fan",
        device_class=SensorDeviceClass.ENUM,
    ...
    MelcloudSensorEntityDescription(
        ...
        translation_key="actual_exhaust_fan_speed",
        icon="mdi:fan",
        device_class=SensorDeviceClass.ENUM,
    ...
    MelcloudSensorEntityDescription(
        ...
        translation_key="filter_maintenance_required",
        icon="mdi:wrench",
        device_class=SensorDeviceClass.ENUM,
    ...
    MelcloudSensorEntityDescription(
        key="night_purge_mode",
        translation_key="night_purge_mode",
        icon="mdi:weather-night",
        device_class=SensorDeviceClass.ENUM,
        value_fn=lambda x: x.device.night_purge_mode,
        enabled=lambda x: True,
    ),
    MelcloudSensorEntityDescription(
        key="room_co2_level",
        translation_key="room_co2_level",
        icon="mdi:air-filter",
